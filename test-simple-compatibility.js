...
/**
 * Script de prueba para verificar compatibilidad entre frontend y backend simplificado
 */

const crypto = require('crypto');

// Simular el algoritmo del backend (Node.js crypto simple)
...
// Pruebas
console.log('🔐 Prueba de Compatibilidad Simplificada Frontend/Backend\n');
...
try {
  ...
  console.log('   Método: createCipher/createDecipher');
