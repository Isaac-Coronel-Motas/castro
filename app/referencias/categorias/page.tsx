...
const sidebarItems = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "Categorías", href: "/referencias/categorias", active: true },
          ...
          <main className="flex-1 overflow-auto p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600">Gestión de categorías de productos y servicios</p>
              </div>
                    ...
                    <tbody>
                      {filteredCategorias.map((categoria, index) => (
                        <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                          <td className="py-3 px-4 font-medium text-gray-900">{categoria.codigo}</td>
                          ...
                          <td className="py-3 px-4 text-gray-600 max-w-xs truncate">{categoria.descripcion}</td>
                          <td className="py-3 px-4">
                            <div className="flex items-center gap-2">
                              <Package className="h-3 w-3 text-gray-400" />
                              <Badge className={getProductosBadge(categoria.productos)}>
                                {categoria.productos} productos
                              </Badge>
                            </div>
                          </td>
                          <td className="py-3 px-4">
                            <Badge className={getEstadoBadge(categoria.estado)}>{categoria.estado}</Badge>
                          </td>
                          <td className="py-3 px-4">
                            <div className="flex items-center gap-2">
...
const categorias = [
  {
    codigo: "CAT-001",
    nombre: "Pantallas",
    descripcion: "Pantallas LCD, OLED y componentes de visualización",
    productos: 15,
    estado: "Activa",
  },
  {
    codigo: "CAT-002",
    nombre: "Baterías",
    descripcion: "Baterías para dispositivos móviles y laptops",
    productos: 8,
    estado: "Activa",
  },
  {
    codigo: "CAT-003",
    nombre: "Accesorios",
    descripcion: "Cables, cargadores y accesorios diversos",
    productos: 32,
    estado: "Activa",
  },
  {
    codigo: "CAT-004",
    nombre: "Componentes",
    descripcion: "Placas madre, procesadores y componentes internos",
    productos: 12,
    estado: "Activa",
  },
  {
    codigo: "CAT-005",
    nombre: "Periféricos",
    descripcion: "Teclados, mouse y dispositivos de entrada",
    productos: 3,
    estado: "Temporal",
  },
  {
    codigo: "CAT-006",
    nombre: "Memoria",
    descripcion: "Memorias RAM, almacenamiento y tarjetas SD",
    productos: 0,
    estado: "Inactiva",
  },
  {
    codigo: "CAT-007",
    nombre: "Audio",
    descripcion: "Auriculares, altavoces y componentes de audio",
    productos: 7,
    estado: "Activa",
  },
]
