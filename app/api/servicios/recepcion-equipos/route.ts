...
export async function GET(request: NextRequest) {
  try {
    // Verificar permisos
    const { authorized, error } = requirePermission('leer_recepcion_equipos')(request);
...
export async function POST(request: NextRequest) {
  try {
    // Verificar permisos
    const { authorized, error } = requirePermission('crear_recepcion_equipos')(request);
...
export async function PUT(
  ...
  try {
    ...
    // Verificar permisos
    const { authorized, error } = requirePermission('procesar_recepcion_equipos')(request);
