...
export async function GET(request: NextRequest) {
  try {
    // Verificar permisos
    const { authorized, error } = requirePermission('leer_reclamos')(request);
...
export async function POST(request: NextRequest) {
  try {
    // Verificar permisos
    const { authorized, error } = requirePermission('crear_reclamos')(request);
...
export async function PUT(
  ...
  try {
    ...
    // Verificar permisos
    const { authorized, error } = requirePermission('resolver_reclamos')(request);
