...
export async function GET(request: NextRequest) {
  try {
    // Verificar permisos
    const { authorized, error } = requirePermission('leer_presupuestos_servicios')(request);
...
export async function POST(request: NextRequest) {
  try {
    // Verificar permisos
    const { authorized, error } = requirePermission('crear_presupuestos_servicios')(request);
...
export async function PUT(
  ...
  try {
    ...
    // Verificar permisos
    const { authorized, error } = requirePermission('aprobar_presupuestos_servicios')(request);
