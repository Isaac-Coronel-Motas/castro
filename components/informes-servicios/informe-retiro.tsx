...
import { InformeRetiro, FiltrosInformeRetiro } from '@/lib/types/informes-servicios'

export function InformeRetiroComponent() {
  const authenticatedFetch = useAuthenticatedFetch()
  const [informe, setInforme] = useState<InformeRetiro | null>(null)
  const [loading, setLoading] = useState(false)
  const [error, setError] = useState<string | null>(null)
  const [filtros, setFiltros] = useState<FiltrosInformeRetiro>({
    fecha_desde: '',
    fecha_hasta: '',
  ...
  const loadInforme = async () => {
    ...
    try {
      ...
      if (filtros.documento_entrega) params.append('documento_entrega', filtros.documento_entrega)
      if (filtros.tipo_periodo) params.append('tipo_periodo', filtros.tipo_periodo)

      const response = await authenticatedFetch.authenticatedFetch(`/api/servicios/informes/retiro?${params.toString()}`)
  ...
  const handleFiltroChange = (key: keyof FiltrosInformeRetiro, value: any) => {
    setFiltros(prev => ({
      ...prev,
      [key]: value
    }))
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Filtros del Informe de Retiro</CardTitle>
          <CardDescription>
            Configure los filtros para generar el informe de retiro de equipos
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                value={filtros.documento_entrega || ''}
                onChange={(e) => handleFiltroChange('documento_entrega', e.target.value)}
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Técnicos con más retiros</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Clientes con más retiros</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Retiros por sucursal</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Evolución de los retiros en los últimos meses</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
