...
import { InformeDiagnosticos, FiltrosInformeDiagnosticos } from '@/lib/types/informes-servicios'

export function InformeDiagnosticosComponent() {
  const authenticatedFetch = useAuthenticatedFetch()
  const [informe, setInforme] = useState<InformeDiagnosticos | null>(null)
  const [loading, setLoading] = useState(false)
  const [error, setError] = useState<string | null>(null)
  const [filtros, setFiltros] = useState<FiltrosInformeDiagnosticos>({
    fecha_desde: '',
    fecha_hasta: '',
  ...
  const loadInitialData = async () => {
    try {
      const [sucursalesRes, tecnicosRes, clientesRes, tiposRes] = await Promise.all([
        ...
        authenticatedFetch.authenticatedFetch('/api/servicios/referencias/tipos-diagnostico')
      ])
  ...
  const loadInforme = async () => {
    ...
    try {
      ...
      if (filtros.estado_diagnostico) params.append('estado_diagnostico', filtros.estado_diagnostico)
      if (filtros.tipo_diag_id) params.append('tipo_diag_id', filtros.tipo_diag_id.toString())
      ...
      const response = await authenticatedFetch.authenticatedFetch(`/api/servicios/informes/diagnosticos?${params.toString()}`)
  ...
  const handleFiltroChange = (key: keyof FiltrosInformeDiagnosticos, value: any) => {
    setFiltros(prev => ({
      ...prev,
      [key]: value
    }))
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Filtros del Informe de Diagnósticos</CardTitle>
          <CardDescription>
            Configure los filtros para generar el informe de diagnósticos
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={filtros.estado_diagnostico || 'all'}
                onValueChange={(value) => handleFiltroChange('estado_diagnostico', value === 'all' ? '' : value)}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={filtros.tipo_diag_id?.toString() || 'all'}
                onValueChange={(value) => handleFiltroChange('tipo_diag_id', value === 'all' ? undefined : parseInt(value))}
              >
                <SelectTrigger>
        ...
        <>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Estado de los diagnósticos</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Técnicos con más diagnósticos</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Clientes con más diagnósticos</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Diagnósticos por sucursal</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Evolución de los diagnósticos en los últimos meses</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
