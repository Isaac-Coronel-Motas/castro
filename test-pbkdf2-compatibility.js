...
/**
 * Script de prueba para verificar compatibilidad completa con PBKDF2
 */
...
// Pruebas
console.log('🔐 Prueba de Compatibilidad Completa con PBKDF2\n');
...
try {
  ...
  console.log('   Formato: iv:encrypted');
